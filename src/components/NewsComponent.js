...
export class NewsComponent extends Component {
  // Practice for constructing the webpage
  //articles = [
  // {
  //   source: {
  //     id: "bbc-news",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/1c88/live/86669850-1064-11f0-ac9f-c37d6fd89579.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/110c/live/c4bd9190-1a27-11f0-a455-cf1d5f751d2f.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/9716/live/e9920830-1a21-11f0-9b40-6d3b8c877a52.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/1ed4/live/9f861960-19eb-11f0-97aa-8f143d28cc2f.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/b12f/live/c23ad620-1a5a-11f0-8a1e-3ff815141b98.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/9214/live/d78831b0-193a-11f0-8fd7-0d6f4cccf9ff.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/6dc7/live/021993c0-1a4d-11f0-b6de-656b207d7440.jpg",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/0eca/live/19974db0-19fa-11f0-8a1e-3ff815141b98.png",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/9b37/live/49a71f10-1a15-11f0-a455-cf1d5f751d2f.jpg",
  //   publishedAt: "2025-04-16T00:07:25.3389442Z",
  //   content:
  //     "The UK government ban on disposable and single-use vapes is aimed at stopping littering as, in most cases, the vapes cannot be recycled and often end up in landfill or pollute natural environments. \r… [+1451 chars]",
  // },
  // {
  //   source: {
  //     id: "bbc-news",
  ...
  //   urlToImage:
  //     "https://ichef.bbci.co.uk/ace/branded_news/1200/cpsprodpb/a99a/live/b73fa290-1a42-11f0-8a1e-3ff815141b98.png",
  //   publishedAt: "2025-04-16T00:07:23.32382Z",
  //   content:
  //     'Image caption, The largest education union in the country, the National Education Union, claims Reform UK is as a "racist and far-right" party, the Guardian reports as its front page lead. The motion… [+214 chars]',
  // },
  //];
  constructor() {
    super();
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/everything?q=apple&from=2025-05-05&to=2025-05-05&sortBy=popularity&apiKey=3ce28dc519024f2586b3b9d326154dd6&page=${this.state.page}&pagesize=20`;
